     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select name="id_pasien" class="form-control">
          ...
          <option value="<?= $p['id_pasien']; ?>"><?= $p['nm_pasien']; ?></option>
            <?php } ?>
        </select>
                ...
                <table id="example1" class="table table-bordered table-striped ">
                  ...
                  <?php $i = 1; ?>
                      ...
                      <tr>
                        ...
                        <!-- <td><?= $rm['nm_obat']; ?></td> -->
                        <td>
                          <a href="<?= base_url('pasien/delete/').$rm['id_pasien']; ?>" class="badge badge-danger" onclick="return confirm('Yakin ingin menghapus data ini?')"> <i class="fas fa-trash"></i></a>
                          <a href="<?= base_url('pasien/resep/').$rm['id_pasien']; ?>" class="badge badge-info" onclick="return confirm('Ingin membuat Resep?')"> <i class="fas fa-eye"></i></a>
                        </td>
                      </tr>
                      <?php $i++; ?>
                      <?php endforeach; ?>

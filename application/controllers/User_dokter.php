...
class User_dokter extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['totalre']= $this->Resep_model->total('resep');
		$data['totalo'] = $this->Obat_model->total('obat');
		$data['totalr'] = $this->Rm_model->total('rkmedis');
		$data['title'] 	= 'Dashboard';
		$data['content']= 'userdokter/index';
		...
		if($this->form_validation->run() == false)
		{
			...
			if (!password_verify($current_password, $data['user']['password']))
			{
				$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Wrong current password!</div>');
					redirect('user_dokter/changepassword');
